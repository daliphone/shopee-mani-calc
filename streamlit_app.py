...
with st.sidebar:
    st.markdown("### 🛠️ 系統資訊")
    st.info("**版本號：** V11.0 Final")
    st.divider()
    st.caption("© 2025 馬尼蝦皮計算機")
...
with col_in:
    ...
    st.markdown("---")
    direct_type = st.selectbox("直送類型 (僅影響直送欄位)", 
...
with col_直:
    st.markdown(f"""<div class="result-card">
        ...
        <p style="color:#95a5a6; font-size:0.85em; margin-top:10px;">(直送模式不計金流/活動費)</p>
        <hr>
